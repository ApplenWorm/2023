...
\textbf{Def 13.1:} Let $A$ be an annulus centered at $z = z_0$ with inner radius $R_1$, outer radius $R_2$, $0 \leq R_1 < R_2 \leq \infty: A = \{z \in \mathbb{C}: R_1 < |z - z_0| < R_2\}$. A series given by $\sum_{n=0}^{\infty} a_n (z - z_0)^n + \sum_{n=1}^{\infty} b_n (z - z_0)^{-n}, a_n, b_n \in \mathbb{C}$ converging to $f(z)$ at every $z \in A$ is called the Laurent series for $f$ on A.
...
\textbf{Def 14.1:} Function of the form $w = az + b, a,b \in \mathbb{C}, a \neq 0$, is called the linear function (linear transformation).
...
\textbf{Prop 14.1:} Möbius transformations send lines and circles to lines and circles.
