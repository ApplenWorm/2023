...
\begin{proposition}\label{proposition:10.1} 
...
Note: From Prop 12.2(\ref{proposition:12.2}): $f(z) = \sum_{n=0}^{\infty} a_n (z - z_0)^n$ is differentiable arbitrarily many times at any $z$ in the disc of convergence of the series (namely, we can define its higher derivatives).
