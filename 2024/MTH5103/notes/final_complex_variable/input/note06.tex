...
\begin{example} \label{example:16.1} For $w = z + 1$: the whole domain is moved by 1 to the right parallel to x-axis. For $w = z - 2i$ - the whole domain is moved by 2 down parallel to y-axis. 
