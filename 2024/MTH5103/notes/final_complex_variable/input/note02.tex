...
\begin{proof}
 Assume $\lim_{z \to z_0} f(z) = a$ and $\lim_{z \to z_0} f(z) = b$. By Def 3.1 for any $\epsilon > 0$ there exist $\delta_1 > 0$ and $\delta_2 > 0$ such that
\begin{align*}
...
\begin{example}\label{example:5.3}
     5.3 Show that $\lim_{z \to 0} \frac{\bar{z}^2}{z^2}$ does not exist.
