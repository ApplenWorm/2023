...
\end{proof}
\end{claim}
Back to Ex 5.2 (\ref{example:5.2}): we will use a common technique to show that the limit does not exist - we will show that there exist two different paths (directions) $z \to z_0$ along which we get 2 different limits.
