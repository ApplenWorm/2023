...
Similarly to Prop~\ref{proposition:16.1}, we have the following proposition which provides a method for recognising the order of a pole and computing the corresponding residue.
