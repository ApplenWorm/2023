...
\begin{soln}
    \begin{enumerate}
        \item Since $\lim_{z \to 3} \frac{(z-3)(z+3)}{z-3} = 6$ and $\lim_{z \to 3} (z-3) \cdot \frac{(z-3)(z+3)}{z-3} = 0$ by Prop 16.1 (\ref{proposition:16.1})$z = 3$ is a removable singularity. 
        ...
        \begin{enumerate}[label=\roman*)]
            ...
            \item $\lim_{z \to 0} z \cdot \frac{\sin z}{z} = \lim_{z \to 0} \sin z = 0 \implies$ by Prop 16.1 (\ref{proposition:16.1}) $z = 0$ is a removable singularity.
        \end{enumerate}
    \end{enumerate}
\end{soln}
