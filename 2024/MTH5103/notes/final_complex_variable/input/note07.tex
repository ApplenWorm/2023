...
\textbf{Thm (Great Picard Theorem)} If an analytic function $f$ has an essential singularity at $z_0$, then on any punctured neighborhood of $z_0$, $f$ takes on all possible 
...
\end{example}
Sol: 1) Since $\lim_{z \to 3} \frac{(z-3)(z+3)}{z-3} = 6$ and $\lim_{z \to 3} (z-3) \cdot \frac{(z-3)(z+3)}{z-3} = 0$ by Prop 16.1 $z = 3$ is a removable singularity. 
