...
The equation $\lvert z-z_0 \rvert <R$ describes all the points that lie inside the circle centered at $z_0$ of radius $R$ (but not on the circle!). \includegraphics{filled_circle.pdf}
...
\textbf{Important}: The argument of $z=0$ is not defined!
 \end{remark}
We have already studied some of the properties of the modulus in proposition 1.2 (\ref{proposition:1.2}).
...
\begin{proof}    
    ...
    \verifythis the rest including the ones from proposition 1.2(\ref{proposition:1.2}) (in the same way).
    1) $z = \lvert z\rvert(\cos\theta + i\sin\theta)$
...
By proposition 1.2.5(\ref{proposition:1.2.5}) part 3): $\lvert \frac{1}{z}\rvert = \frac{1}{\lvert z\rvert}$ and since $z\cdot \frac{1}{z} = 1$
