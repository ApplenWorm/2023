...
\begin{soln}
 ...
 \emphi{Note:} $f(z) = \frac{z}{(9-z^2)(z+i)}$ has simple poles at $z = -i, \pm 3$ (\verifythis) and only $z = -i$ is enclosed by $C$. Therefore:
    ...
    \end{equation*}
    where $f(z) = \frac{z}{9-z^2}$ is analytic on and everywhere inside $C$. By CIF (18.7)(\ref{theorem:Cauchy.Integral.formula.18.7}:
    %%%%%%
...
\begin{proof}
    ...
    (Sketch!): Choose a small, positively oriented circle around $z_0$ such that $f$ is analytic on and everywhere inside it. By CIF: $f(z_0) = \frac{1}{2\pi i} \int_C \frac{f(z)}{z - z_0} dz$.
