...
\emphi{Note:} one cannot always differentiate under an integral in this manner. We should, in fact, prove a technical lemma, justifying why we are allowed to perform such an operation. For example, the first derivative - we need to interchange $\lim_{\Delta z \to 0}$ and the integral and this requires justification!
\end{proof}
