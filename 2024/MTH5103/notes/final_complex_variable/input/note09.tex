...
By Def 17.7 (\ref{definition:17.7}) (of the contour integral) $\int_C \frac{dz}{(z-z_0)^n} = \int_0^{2\pi} \frac{iRe^{it}}{R^n e^{int}} dt = \frac{i}{R^{n-1}} \int_0^{2\pi} e^{i(1-n)t} dt$.
...
The picture that you should have in mind here is where D is a domain that contains both curves and the region between them: [PICTURE!] \includegraphics{img_graph7.pdf}
\begin{proof}
