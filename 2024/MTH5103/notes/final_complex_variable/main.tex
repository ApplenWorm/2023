...
% \week{1}
% \lecture{1}{Date}
\include{input/note01} % Week 1
\include{input/note02} % Week 2
\include{input/note03} % Week 3
\include{input/note04} % Week 4
\include{input/note05} % Week 5
\include{input/note06} % Week 6
\include{input/note07} % Week 8
\include{input/note08} % Week 9
\include{input/note09} % Week 10
% \include{input/note10} % Week 11
% \include{input/note11} % Week 12
